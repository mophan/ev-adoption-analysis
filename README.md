# 🚗 EV Adoption Exploratory Data Analysis (EDA) in Washington State
...
## Project Objectives
The goal of this EDA is to answer the following research questions:
...
- Correlation analysis & aggregation
- Policy-aware data interpretation
